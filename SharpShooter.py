...
from modules import *
from modules.concat_rand import *
import re
...
class SharpShooter:
	...
	SUPER/____/_/ /_/\__,_/_/  / .___/____/_/ /_/\____/\____/\__/\___/_/
	 ...
	 \033[1;32mSYANiDE, v2.0 Whiskey Tango Foxtrot edition\033[0;0m
	"""
	...
	def fix_hardcode(self, base, method):
		...
		print("[*] Preview:  %s" % re.findall(pat,plain)[0])
		print(plain)
		return plain
...
End Sub"""
		...
		template_code = self.fix_hardcode(template_code, code_type)
